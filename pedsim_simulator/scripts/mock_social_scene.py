...
PEOPLE = {
    1: create_mock_state(1, 5, 4, 45),
    2: create_mock_state(2, 6, 5.45878, 60),
    3: create_mock_state(3, 7.22, 5.70, 50),
    4: create_mock_state(4, 2 + 7.22, 7.33, 40),
    5: create_mock_state(5, 2 + 8.92, 8.42, 30),
    6: create_mock_state(6, 2 + 7.92, 10.41, 50),
    7: create_mock_state(7, 2 + 7.2, 9.44, 40),
    8: create_mock_state(8, 2 + 7, 14 - 2, 60),
    9: create_mock_state(9, 2 + 6, 15.4123 - 2, 60),
    10: create_mock_state(10, 5 - 1, 18.595 - 5, 280),
    11: create_mock_state(11, 5 - 1, 20 - 5, 250),
    12: create_mock_state(12, 6 - 1, 21.5491 - 5, 240),
    13: create_mock_state(13, 7.48044 - 1, 19 - 5, 50),
